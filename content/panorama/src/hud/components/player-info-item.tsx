...
export class PlayerInfoItem extends React.Component<props, any> {
    ...
    render() {
        ...
        return <Panel style={{position: position, border: '1px solid #ffffff', padding: '5px 5px', width: '100%', height: '80px', flowChildren: 'right', backgroundColor: '#333333', borderRadius: '10px 0 0 10px'}}>
