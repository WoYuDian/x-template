...
import { fa_li_zhuo_shao_debuff } from "./fa_li_zhuo_shao_debuff";

import { getForceOfRuleLevel } from "../../game_logic/realm_manager";
@registerModifier()
export class modifier_fa_li_zhuo_shao extends BaseModifier {
    ...
    OnTakeDamage(params: ModifierInstanceEvent): number {
        ...
        if (params.damage_type == DamageTypes.MAGICAL) {
            ...
            if(!debuff) {
                params.unit.AddNewModifier(params.attacker, this.GetAbility(), fa_li_zhuo_shao_debuff.name,
